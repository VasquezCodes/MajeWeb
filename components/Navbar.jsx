      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="flex-shrink-0 relative">
            {/* Arbolito navideño animado - solo visible en temporada navideña */}
            {isChristmasSeason && (
              <div className="christmas-tree-navbar" aria-hidden="true">
            ...
            <Link href="/" className="text-3xl font-crimson font-semibold text-brand-black hover:text-brand-gray-dark transition-colors duration-300">
              {pathname === '/academia' ? 'Maje Nail Academy' : 'Maje Nail Spa'}
            </Link>
          </div>
